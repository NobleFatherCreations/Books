...
BOOKS = [
    ("sovereign", "The Sovereign Divine Feminine", "static",
     os.path.join(ROOT, "library/feminine/index.html")),
    ("playground", "Playground Protectors", "static",
     os.path.join(ROOT, "library/children/index.html")),
    ("festival", "The Festie Codex", "static",
     os.path.join(ROOT, "library/wook/index.html")),
    ...
    ("root", "The Root", "root",
     os.path.join(ROOT, "instruments/shadowroot/index.html")),
